...
from neural_field_optimal_planner.constrained_nerf_opt_planner import ConstrainedNERFOptPlanner
...
class TestNERFOptPlanner(unittest.TestCase):
    def setUp(self) -> None:
        ...
        trajectory = torch.zeros(100, 3, requires_grad=True)
        trajectory_optimizer = torch.optim.Adam([trajectory], 1e-2)
        self._planner = ConstrainedNERFOptPlanner(trajectory, collision_model, collision_checker, collision_optimizer,
    ...
    def test_get_path(self):
        ...
        self.assertEqual(path.shape, (102, 3))

    def test_full_path(self):
        full_path = self._planner.full_trajectory()
        self.assertEqual(full_path.shape, (102, 3))
